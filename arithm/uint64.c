...
PG_FUNCTION_INFO_V1(uint8_add_uint1);
Datum uint8_add_uint1(PG_FUNCTION_ARGS)
{
...
PG_FUNCTION_INFO_V1(uint8_sub_uint1);
Datum uint8_sub_uint1(PG_FUNCTION_ARGS)
{
    uint64 a = PG_GETARG_UINT64(0);
    uint8 b = PG_GETARG_UINT8(1);
    uint64 result = 0;
...
PG_FUNCTION_INFO_V1(uint8_mul_uint1);
Datum uint8_mul_uint1(PG_FUNCTION_ARGS)
{
    uint64 a = PG_GETARG_UINT64(0);
    uint8 b = PG_GETARG_UINT8(1);
    uint64 result = 0;
...
PG_FUNCTION_INFO_V1(uint8_div_uint1);
Datum uint8_div_uint1(PG_FUNCTION_ARGS)
{
    uint64 a = PG_GETARG_UINT64(0);
    uint8 b = PG_GETARG_UINT8(1);
    if (b == 0) {
...
PG_FUNCTION_INFO_V1(uint8_mod_uint1);
Datum uint8_mod_uint1(PG_FUNCTION_ARGS)
{
    uint64 a = PG_GETARG_UINT64(0);
    uint8 b = PG_GETARG_UINT8(1);
    if (b == 0) {
...
PG_FUNCTION_INFO_V1(uint8_add_int1);
Datum uint8_add_int1(PG_FUNCTION_ARGS)
{
    uint64 a = PG_GETARG_UINT64(0);
...
PG_FUNCTION_INFO_V1(uint8_sub_int1);
Datum uint8_sub_int1(PG_FUNCTION_ARGS)
{
    uint64 a = PG_GETARG_UINT64(0);
    int8 b = PG_GETARG_INT8(1);
    uint64 result = 0;
...
PG_FUNCTION_INFO_V1(uint8_mul_int1);
Datum uint8_mul_int1(PG_FUNCTION_ARGS)
{
    uint64 a = PG_GETARG_UINT64(0);
    int8 b = PG_GETARG_INT8(1);
    uint64 result = 0;
...
PG_FUNCTION_INFO_V1(uint8_div_int1);
Datum uint8_div_int1(PG_FUNCTION_ARGS)
{
    uint64 a = PG_GETARG_UINT64(0);
    int8 b = PG_GETARG_INT8(1);
    if (b == 0) {
...
PG_FUNCTION_INFO_V1(uint8_mod_int1);
Datum uint8_mod_int1(PG_FUNCTION_ARGS)
{
    uint64 a = PG_GETARG_UINT64(0);
    int8 b = PG_GETARG_INT8(1);
    if (b == 0) {
