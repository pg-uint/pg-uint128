...
PG_FUNCTION_INFO_V1(int16_add_int1);
Datum int16_add_int1(PG_FUNCTION_ARGS)
{
...
PG_FUNCTION_INFO_V1(int16_sub_int1);
Datum int16_sub_int1(PG_FUNCTION_ARGS)
{
    int128 a = PG_GETARG_INT128(0);
    int8 b = PG_GETARG_INT8(1);
    int128 result = 0;
...
PG_FUNCTION_INFO_V1(int16_mul_int1);
Datum int16_mul_int1(PG_FUNCTION_ARGS)
{
    int128 a = PG_GETARG_INT128(0);
    int8 b = PG_GETARG_INT8(1);
    int128 result = 0;
...
PG_FUNCTION_INFO_V1(int16_div_int1);
Datum int16_div_int1(PG_FUNCTION_ARGS)
{
    int128 a = PG_GETARG_INT128(0);
    int8 b = PG_GETARG_INT8(1);
    if (b == 0) {
...
PG_FUNCTION_INFO_V1(int16_mod_int1);
Datum int16_mod_int1(PG_FUNCTION_ARGS)
{
    int128 a = PG_GETARG_INT128(0);
    int8 b = PG_GETARG_INT8(1);
    if (b == 0) {
...
PG_FUNCTION_INFO_V1(int16_add_uint1);
Datum int16_add_uint1(PG_FUNCTION_ARGS)
{
    int128 a = PG_GETARG_INT128(0);
...
PG_FUNCTION_INFO_V1(int16_sub_uint1);
Datum int16_sub_uint1(PG_FUNCTION_ARGS)
{
    int128 a = PG_GETARG_INT128(0);
    uint8 b = PG_GETARG_UINT8(1);
    int128 result = 0;
...
PG_FUNCTION_INFO_V1(int16_mul_uint1);
Datum int16_mul_uint1(PG_FUNCTION_ARGS)
{
    int128 a = PG_GETARG_INT128(0);
    uint8 b = PG_GETARG_UINT8(1);
    int128 result = 0;
...
PG_FUNCTION_INFO_V1(int16_div_uint1);
Datum int16_div_uint1(PG_FUNCTION_ARGS)
{
    int128 a = PG_GETARG_INT128(0);
    uint8 b = PG_GETARG_UINT8(1);
    if (b == 0) {
...
PG_FUNCTION_INFO_V1(int16_mod_uint1);
Datum int16_mod_uint1(PG_FUNCTION_ARGS)
{
    int128 a = PG_GETARG_INT128(0);
    uint8 b = PG_GETARG_UINT8(1);
    if (b == 0) {
