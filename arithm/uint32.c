...
PG_FUNCTION_INFO_V1(uint4_add_uint1);
Datum uint4_add_uint1(PG_FUNCTION_ARGS)
{
...
PG_FUNCTION_INFO_V1(uint4_sub_uint1);
Datum uint4_sub_uint1(PG_FUNCTION_ARGS)
{
    uint32 a = PG_GETARG_UINT32(0);
    uint8 b = PG_GETARG_UINT8(1);
    uint32 result = 0;
...
PG_FUNCTION_INFO_V1(uint4_mul_uint1);
Datum uint4_mul_uint1(PG_FUNCTION_ARGS)
{
    uint32 a = PG_GETARG_UINT32(0);
    uint8 b = PG_GETARG_UINT8(1);
    uint32 result = 0;
...
PG_FUNCTION_INFO_V1(uint4_div_uint1);
Datum uint4_div_uint1(PG_FUNCTION_ARGS)
{
    uint32 a = PG_GETARG_UINT32(0);
    uint8 b = PG_GETARG_UINT8(1);
    if (b == 0) {
...
PG_FUNCTION_INFO_V1(uint4_mod_uint1);
Datum uint4_mod_uint1(PG_FUNCTION_ARGS)
{
    uint32 a = PG_GETARG_UINT32(0);
    uint8 b = PG_GETARG_UINT8(1);
    if (b == 0) {
...
PG_FUNCTION_INFO_V1(uint4_add_int1);
Datum uint4_add_int1(PG_FUNCTION_ARGS)
{
    uint32 a = PG_GETARG_UINT32(0);
...
PG_FUNCTION_INFO_V1(uint4_sub_int1);
Datum uint4_sub_int1(PG_FUNCTION_ARGS)
{
    uint32 a = PG_GETARG_UINT32(0);
    int8 b = PG_GETARG_INT8(1);
    uint32 result = 0;
...
PG_FUNCTION_INFO_V1(uint4_mul_int1);
Datum uint4_mul_int1(PG_FUNCTION_ARGS)
{
    uint32 a = PG_GETARG_UINT32(0);
    int8 b = PG_GETARG_INT8(1);
    uint32 result = 0;
...
PG_FUNCTION_INFO_V1(uint4_div_int1);
Datum uint4_div_int1(PG_FUNCTION_ARGS)
{
    uint32 a = PG_GETARG_UINT32(0);
    int8 b = PG_GETARG_INT8(1);
    if (b == 0) {
...
PG_FUNCTION_INFO_V1(uint4_mod_int1);
Datum uint4_mod_int1(PG_FUNCTION_ARGS)
{
    uint32 a = PG_GETARG_UINT32(0);
    int8 b = PG_GETARG_INT8(1);
    if (b == 0) {
